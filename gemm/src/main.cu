...
int main() {
    ...
    benchmark("GEMM CUDA Tensor Core Double Buffering", gemm_tensor_double_buffering, result_tensor_buffering_gpu.data(), a_half.data(), b_half.data(), rows, cols, rows, cols);
